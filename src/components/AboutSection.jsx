...
const AboutSection = () => {
  ...
  return (
    <div className={`flex flex-col md:flex-row lg:px-10`}> 
      ...
      <div className={`w-full md:w-1/2 p-4`}> 
        {/* Added p-4 for some basic padding */}
        <img src="https://images.unsplash.com/photo-1578909196400-59f8f8156a05?q=80&w=1935&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" className='w-full object-cover rounded-3xl' /> 
