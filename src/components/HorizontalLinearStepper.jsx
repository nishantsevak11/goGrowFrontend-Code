  ...
  const handleSubmit = async() => {
    try {
          const response = await registerUser(
              personalInfo.name, personalInfo.email, personalInfo.password, serviceQuestions.sendTime, serviceQuestions.platform, serviceQuestions.categories, serviceQuestions.AiPrompt
          );
      ...
      {activeStep === steps.length ? (
        ...
        <React.Fragment>
          ...
          {activeStep === 1 && (
            <Box sx={{ mt: 2 }}>
              <TextField
                label="When You want to receive quates daily"
                variant="outlined"
                fullWidth
                name="sendTime"
              ...
              />
              <TextField
                label="Can you add some msg for Ai for personalised message"
                variant="outlined"
                fullWidth
                name="AiPrompt"
